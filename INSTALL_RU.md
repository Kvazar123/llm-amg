...
**Вопросы задаются фиксированными сериями, не больше четырёх в серии.** Инструмент опроса среды принимает максимум четыре вопроса за вызов, поэтому поток — последовательность СЕРИЙ: ни одного свёрнутого «всё в одном сообщении», ни одной серии крупнее четырёх. Пустой ответ берёт названное умолчание — но сам вопрос всё равно звучит: молчаливые умолчания на КЛЮЧЕВЫХ пунктах — прямой путь к графу не на том языке или без эмбеддингов. Серии:
