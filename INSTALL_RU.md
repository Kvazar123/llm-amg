...
- **`working_language` — решить до сборки.** Сводки и кэш дериваций ключуются языком; поздняя смена сама по себе ничего не пересводит (граф расползается на два языка), а чистый переход стоит полного повторного обогащения семантического слоя.
