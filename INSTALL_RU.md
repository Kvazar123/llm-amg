...
**Каждый вопрос задаётся, по одному.** Вопросы не пропускаются и не сворачиваются в одно сообщение. Пустой ответ берёт названное умолчание — но сам вопрос всё равно звучит: молчаливые умолчания на КЛЮЧЕВЫХ пунктах — прямой путь к графу не на том языке или без эмбеддингов. Вопросы 6 и 7 помечены **КЛЮЧЕВОЙ**: их ответы дорого менять после сборки графа (см. «Что менять потом дёшево, а что решить до сборки»).
