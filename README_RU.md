...
> Хуки `SessionStart`/`SessionEnd`/`UserPromptSubmit`, слэш-команда `/amg` и `@`-импорт дайджеста — механизмы именно Claude Code; в других средах их состав зависит от выбранного при установке `--env` (Codex / generic), подробнее — раздел «Установка», пункт «Другие среды».
