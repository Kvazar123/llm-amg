...
Сборка графа сделана корректной и связной: детерминированный хребет рёбер (вызовы резолвятся между файлами, принадлежность и наследование извлекаются кодом), глобальная смысловая линковка доменов, устойчивое к битым элементам применение, приёмочный отчёт связности и воспроизводимая пересборка из кэша дериваций. В планах ([дорожная карта](docs/ru/architecture/11-roadmap.md)): экономная сборка на больших проектах (кратное снижение стоимости и времени без потери качества); перевод документации на английский.
