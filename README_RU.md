...
**2. Установка — двумя способами.** Оба делают одно и то же; выбирайте удобный.

*Силами модели (проще).* Скажите в Claude Code:

> **установи AMG по INSTALL.md**

Модель задаст несколько вопросов (локально/глобально; каталог агента и точка входа; зеркала и впитывание; рабочий язык; эмбеддинги; автоматика; что игнорировать; активировать ли память) и сама вызовет установщик.

*Вручную, командой.* Если хотите задать всё сами:
```bash
...
Базовая работоспособность от среды не зависит, набор удобств — зависит. **Эти режимы пока не протестированы** в любой не-Claude-Code-среде — все тесты в Claude Code (проверка — Этап 19 дорожной карты).
