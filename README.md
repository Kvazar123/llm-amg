...
Planned ([roadmap](docs/en/architecture/11-roadmap.md)): reliable and economical graph building on large real projects (deterministic connectivity and reproducibility, a multi-fold cut in build cost); and the English translation of the documentation.
