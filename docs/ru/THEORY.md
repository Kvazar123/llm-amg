...
- хеббово обновление включается **явно** (`apply_hebbian: true`) и только после того, как измерение (сравнение полноты «веса on/off» на размеченных случаях, §14; автоматический предохранитель — дорожная карта) подтвердит выигрыш;
