...
- селфтесты зелёные; закрыты §1.55–§1.60 (группами A–C), §1.61–§1.65 (группой E), §1.66–§1.69 (группой F) и §1.70–§1.74 (группой G); правка каждого документа выполнена зеркально в `docs/ru` и `docs/en` (§3.5).
