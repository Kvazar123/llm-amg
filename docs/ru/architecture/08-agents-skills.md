...
- `true` — модель ведёт петлю сама, а хуки `SessionStart`/`SessionEnd` автоматически исцеляют хранилище, сворачивают веса и обновляют дайджест;
...
- **Сохранение сессий** — `SessionEnd` будет выгружать диалог в `sessions/ГГГГ-ММ-ДД-ЧЧММ.md` (markdown с маркерами ролей, без сырых размышлений); путь и `session_policy` (`absorb`|`mirror`, по умолчанию `absorb`) — в конфиге. Сейчас `session-end` сворачивает веса и дайджест, но стенограмму не пишет (Этап 9).
