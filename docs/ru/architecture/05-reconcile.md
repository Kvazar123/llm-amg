...
| `python reconcile.py apply-derived [<project_root>] [--root <agent_dir>]` | пакетная дверь: применить **все** `work/derived-*.json` (включая чекпоинт-части) одним вызовом (см. «Применение семантики») |
